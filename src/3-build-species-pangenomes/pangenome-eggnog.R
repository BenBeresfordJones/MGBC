...
option_list = list(
	...
	make_option(c("-o", "--outdir"), type="character", default=NULL,
        ...
        make_option(c("-K", "--KO_index"), type="character", default=NULL,
              help="Path to the KO index [optional].", metavar="character")
); 
...
if (is.null(opt$KO_index)){
  opt$KO_index <- "/lustre/scratch118/infgen/team162/bb11/Human_mouse_comparison/FUNCTIONAL_COMPARISON/REPRESENTATIVE_eggNOG/KEGG_DB/KO_index"
}
...
merged <- merge(KO, data[,c(1,4)], all.x=TRUE)
...
colnames(merged)[2] <- opt$species_name
